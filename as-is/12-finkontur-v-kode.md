# 12. Финансовый контур в коде и БД — как есть (2026-09-17, обновлено 2026-09-19)
...
шаг всего пути МСП. Исключение (SZ-050 Ф2, 17.09): заявка с ИНН уже
верифицированного своего юрлица (без промокода) создаёт бренд в существующем
юрлице и сразу Verified — без счёта 1 ₽.
...
| Внешняя карта в каскаде подписки | каркас (попытка = failed external_unavailable) — ждёт банк-контур |
| P2P-переводы | не реализованы (утверждены: лимиты 100–3 000 ₽, комиссия 0,5–3,5% — gemini-code-1789669703545.md) |
...
3. Тестовый контур Т-Банка → автоматическое исполнение выплат и внешняя карта
   в каскаде подписки (каркас уже стоит).
